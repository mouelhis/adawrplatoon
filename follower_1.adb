...
procedure Follower_1 is
   ...
   task Listen_Leader_Velocity  is 
      pragma Priority(System.Priority'Last); 
   end Listen_Leader_Velocity;
   ...
   task body Listen_Leader_Velocity is 
   begin
   ...
   begin
      ...
      loop
         Release := Ada.Real_Time.Clock;
         -- if Instance.Brake_Alarm_Status = True then 
